-- Path: ReplicatedStorage.IlllllllIlIlIllIlIIIlIlIIlllllIllIIIlIIIlIIIlIllllIIIllIIllI
...
function module.typeWrite(arg1, arg2, arg3) -- Line 21
	...
	local var11 = arg2
	if var1_upvw then
		var11 = var1_upvw:Translate(arg1, arg2)
	end
	local any_gsub_result1 = var11:gsub("<br%s*/>", '\n'):gsub("<[^<>]->", "")
	arg1.Text = any_gsub_result1
	for _, _ in utf8.graphemes(any_gsub_result1) do
		arg1.MaxVisibleGraphemes = 0 + 1
		if Random.new():NextNumber(0.1, 0.2) <= tick() - 0 then
			script.Sound:Play()
		end
		task.wait(arg3)
	end
